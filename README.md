...
**Quick workaround for your demo:**

Before showing the app to evaluators, open this URL in your browser first to wake the server up:
```
https://marketnest-api-4ox8.onrender.com
